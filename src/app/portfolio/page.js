...
const ProjectPage = ({ project }) => {
  ...
  // Sort projects based on the selected sorting option
  ...
  return (
    <div className="bg-gray-800 m-8 bg-opacity-50 backdrop-filter backdrop-blur-lg py-8 px-6 rounded-lg text-white">
      <div className="max-w-6xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-center text-gray-800 mb-8">Project Showcase</h1>
        
        {/* Sorting Options */}
        <div className="flex justify-center mb-4">
          <label className="mr-2 text-black">Sort By:</label>
          <select value={sortBy} onChange={handleSortChange} className="bg-gray-800">
