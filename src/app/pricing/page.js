      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {pricingTiers.map((tier, index) => (
            <div className="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-lg py-8 px-6 rounded-lg" key={index}>
        ...
        <div className="mt-[16%] ml-[-40%]">
          <h3 className="text-2xl font-bold text-center mb-4 mr-[15%] ">Why Choose Our Pricing Plans?</h3>
          <ul className="list-disc list-inside ml-[28%]">
        ...
        <div className="flex justify-end mt-[-23%] mr-[-16%]">
