...
const Skill = () => {
  const skills = [
    ...
    { id: 3, name: 'Node.js', icon: <DiNodejs /> },
  ...
  return (
    <div className="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-lg m-10 py-10 rounded-lg">
      <h2 className="text-white text-3xl font-bold mb-6 text-center">Tech Stack</h2>
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {skills.map((skill) => (
          <div key={skill.id} className="flex flex-col items-center p-4 bg-gray-700 rounded-lg text-white">
            {skill.icon}
